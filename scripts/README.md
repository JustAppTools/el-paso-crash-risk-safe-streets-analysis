...
- `generate_static_preview.py`: creates `docs/assets/initial-safe-streets-preview.svg` from public Vision Zero layers.
- `build_cris_derived_summaries.py`: creates aggregate CRIS-derived summary tables from the public Vision Zero collision layer without storing raw crash records.
